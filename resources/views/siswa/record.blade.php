...
<x-layouts.app :title="$title">
    <a class="mb-5 inline-flex items-center gap-1.5 text-[0.7rem] font-extrabold text-[#5c1919] hover:underline" href="{{ route('siswa.history') }}">
    ...
    <x-dashboard
        ...
        copy="Informasi lengkap catatan poin yang tercatat untukmu."
    />
