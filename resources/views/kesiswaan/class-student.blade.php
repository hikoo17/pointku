...
<x-layouts.app :title="$title">
    ...
    <div class="mb-6 grid grid-cols-2 gap-4 min-[1051px]:grid-cols-4">
        @foreach([
            ['Poin Pelanggaran', $siswa->total_poin_pelanggaran, 'circle-alert', 'text-rose-700', 'bg-rose-50 border-rose-100', 'border-t-rose-600'],
            ['Poin Apresiasi', $siswa->total_poin_apresiasi, 'heart', 'text-amber-700', 'bg-amber-50 border-amber-100', 'border-t-amber-500'],
