...
<x-layouts.app :title="$title">
    ...
    <div class="mb-6 grid grid-cols-2 gap-4 min-[1051px]:grid-cols-4">
        @foreach([
            ...
            ['Jumlah Pelanggaran', 'violations', 'circle-alert', 'text-rose-700', 'bg-rose-50 border-rose-100', 'border-t-rose-600', 'Kejadian disetujui'],
            ['Jumlah Apresiasi', 'appreciations', 'heart', 'text-emerald-700', 'bg-emerald-50 border-emerald-100', 'border-t-emerald-600', 'Kejadian disetujui'],
                    ...
                    @forelse($students as $student)
                        ...
                        <div class="min-w-0">
                            ...
                            <td class="px-5 py-3.5 text-right">
                                <a class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 shadow-2xs transition hover:border-slate-300 hover:bg-slate-100 hover:text-slate-900" href="{{ route('kesiswaan.classes.student.show', [$kelas, $student]) }}">
